...
function DataForm() {
    ...
    useEffect(() => { 
        axios.get('https://cheery-marzipan-26ddc3.netlify.app/.netlify/functions/api') 
            .then((response) => { 
    ...
    const handleSubmit = (e, id = null) => { 
        ...
        const url = editItem 
            ? `https://cheery-marzipan-26ddc3.netlify.app/.netlify/functions/api/${editItem._id}`
            : 'https://cheery-marzipan-26ddc3.netlify.app/.netlify/functions/api';
    ...
    const handleDelete = (_id) => { 
        axios 
            .delete(`https://cheery-marzipan-26ddc3.netlify.app/.netlify/functions/api/${_id}`) 
            .then(() => { 
